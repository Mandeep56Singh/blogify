...
//import com.mandeep.blogify.shared.exceptions.AppProblemDetail;
...
//
//    @Transactional
//    public Response<ImageDto> uploadImage(MultipartFile file) throws IOException {
//
//        // checking file type
//        String detectedType = tika.detect(file.getInputStream());
//        if (!detectedType.startsWith("image/")) {
//            AppProblemDetail appProblem = AppProblemDetail.getDetail(ImageUploadError.IMAGE_INVALID_TYPE);
//            return Response.failure(appProblem);
//        }
//
...
//            AppProblemDetail appProblem = AppProblemDetail.getDetail(ImageUploadError.IMAGE_UPLOAD_FAILED);
//            return Response.failure(appProblem);
//        }
//
...
//        return Response.success(mapper.toDto(storedImage));
//    }
//
//    @Transactional
//    public Response<ImageResourceDto> loadImage(String id) {
//        Optional<Image> image = imageRepository.findById(id);
//        if (image.isEmpty()) {
//            return Response.failure(ImageUploadError.IMAGE_NOT_FOUND);
//        }
//
...
//                return Response.failure(ImageUploadError.IMAGE_NOT_FOUND);
//            }
//            return Response.success(new ImageResourceDto(resource), Map.of(ImageConstants.CONTENT_TYPE, image.get().getContentType()));
